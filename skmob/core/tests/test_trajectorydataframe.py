...
from skmob.utils.constants import UID, DATETIME, LATITUDE, LONGITUDE, GEOMETRY


EXPECTED_NUM_OF_COLUMNS_IN_TDF = 5
...
class TestTrajectoryDataFrame:
    ...
    def perform_default_asserts(self, tdf):
        ...
        assert tdf[GEOMETRY][0] == Point(116.319236, 39.984094)
